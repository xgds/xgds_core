...
XGDS_CORE_SHOW_CREATE_FLIGHTS = True
...
XGDS_SSE_CONDITION_HISTORY_CHANNELS = ['sse']
XGDS_CONDITION_HISTORY_SSE_TYPE = "condition_history"

XGDS_SSE_GROUP_FLIGHT_CHANNELS = ['sse']
XGDS_GROUP_FLIGHT_SSE_TYPE = "group_flight"

XGDS_SSE_FLIGHT_CHANNELS = ['sse']
XGDS_FLIGHT_SSE_TYPE = "flight"
